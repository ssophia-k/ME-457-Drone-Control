...
class MAVWorldCameraViewer:
    def __init__(self,app, plot_path=True, ts_refresh=1./30.):
        self.scale = 2500
        ...
        grid.scale(self.scale/25, self.scale/25, self.scale/25) # set the size of the grid (distance between each line)
